...
contract TownShip is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x1c9a7e73285A673BEDd509B60f549fD214516253)); // MarketingWallet
    ...
    constructor() ERC20("Meta TownShip", "TOWNSHIP") {
